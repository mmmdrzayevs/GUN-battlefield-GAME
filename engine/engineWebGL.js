...
let glEnable = 1;      // can run without gl (texured coloring will be disabled) - mutable: falls back to the 2D canvas path automatically if WebGL creation fails (see appMobileControls.js)
